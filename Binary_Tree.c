...
{
    struct Tree *floatn = (struct Tree *)malloc(sizeof(struct Tree));
    floatn->data = var;
    floatn->prev = 0;
    floatn->next = 0;
    return floatn;
...
int height(struct Tree *root)
{
    ...
    return (max(height(root->prev), height(root->next)) + 1);
}
 ...
 */
    ...
    struct Tree *elem1 = create(50);
    struct Tree *elem2 = create(150);
    struct Tree *elem11 = create(25);
    struct Tree *elem12 = create(75);
